ServerEvents.recipes(event => {
    ...
    /*
     * ---------------------------------------------------------
     * Prestige component chain
     * ---------------------------------------------------------
     *
     * Near-creative equipment must prove several independent late-game
     * capabilities. No single mod-local material ladder is allowed to produce
     * the final equipment by itself.
     */
    ...
    /*
     * ---------------------------------------------------------
     * Extreme equipment policy
     * ---------------------------------------------------------
     *
     * MekaSuit and Meka-Tool provide survival, mobility and mining capability
     * close enough to creative-mode utility that they are treated as prestige
     * rewards for completing the complete Matterworks industrial program.
     */
